    ...
    <section id="sobre" ref={sectionRef} className="py-24 bg-[#0A1628] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left Column - Image */}
          <div className="about-animate opacity-0 relative">
          ...
          <div className="space-y-8">
            <div className="about-animate opacity-0 space-y-4">
            ...
            <div className="about-animate opacity-0 space-y-4 text-white/70 leading-relaxed">
              <p>
            ...
            {/* Stats Grid */}
            <div className="about-animate opacity-0 grid grid-cols-2 gap-6 pt-4">
