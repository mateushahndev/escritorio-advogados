      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Diferenciais - Removido opacity-0 */}
            ...
            {/* Stats - Removido opacity-0 */}
            <div className="flex flex-wrap gap-8 pt-8 mt-4 border-t border-white/10">
          ...
          {/* Right Column - Image - Removido opacity-0 */}
